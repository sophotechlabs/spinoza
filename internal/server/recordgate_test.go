...
var localOnly = map[string]string{
	...
	"/api/clusters/timeline":    "whether this machine records what the cluster does",
	...
	"/api/checks/baseline/file": "hands that past audit out as a file, and takes one back",
}
