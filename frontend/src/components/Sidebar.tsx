...
export default function Sidebar() {
  return (
    <nav className="w-56 shrink-0 border-r border-neutral-800 bg-neutral-950 overflow-y-auto py-2">
      <div className="mb-2">
      ...
      {inactiveGroups.map((group) => (
        <div
          key={group}
          className="px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-neutral-600"
        >
          {group}
        </div>
      ))}
