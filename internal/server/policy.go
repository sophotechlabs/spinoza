...
var neededRole = map[string]string{
	...
	routeKey(http.MethodGet, "/metrics"):                  auth.RoleAdmin,
	routeKey(http.MethodGet, "/api/transcripts"):          auth.RoleAdmin,
	routeKey(http.MethodGet, "/api/transcripts/text"):     auth.RoleAdmin,
	routeKey(http.MethodGet, "/api/history/export"):       auth.RoleAdmin,
	routeKey(http.MethodGet, "/api/support"):              auth.RoleAdmin,
...
var needsWholeCluster = map[string]bool{
	...
	routeKey(http.MethodGet, "/api/checks/frameworks"):     true,
	routeKey(http.MethodGet, "/api/checks/runs"):           true,
	routeKey(http.MethodGet, "/api/waste"):                 true,
	...
	routeKey(http.MethodGet, "/api/history/export"):        true,
